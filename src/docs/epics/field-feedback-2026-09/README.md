...
- 작성일: 2026-09-07
- 운영에 떠 있는 것: 웹 `6c2066a`(**2026-09-07 배포**, PR #34, `DEPLOY.md` §0) · iOS App Store 빌드 2(2026-09-02 제출) · Android 는 아직 Play 미제출(사이드로드)
...
| F-13 | (현장 발견) 「알림 받는 중」인데 지령 안 옴 | 켜짐 기록·구독이 계정이 아니라 기기에 묶여 있었다 — 다른 계정이 먼저 쓴 기기 | 웹 | ✅ 09-07 구현(PR #37) |
