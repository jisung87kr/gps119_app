...
- 작성일: 2026-09-07
- 운영에 떠 있는 것: 웹 `308da4d`(**2026-09-07 배포 8회**, PR #34~#55, `DEPLOY.md` §0) · iOS **빌드 4 업로드 2026-09-07 23:01**(빌드 3 은 22:52, 실기기로 사이렌 확인 · App Store 는 빌드 2 제출 상태) · Android 는 아직 Play 미제출(사이드로드)
