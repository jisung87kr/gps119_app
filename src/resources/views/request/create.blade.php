        ...
        <div id="bottom-sheet" class="bg-white fixed left-0 bottom-0 right-0 p-5 z-[99] bottom-sheet border-t border-gray-100 transition-transform duration-300 ease-out"
            ...
            <div class="max-w-7xl w-full mx-auto">
                ...
                <div class="grid grid-cols-4 gap-2">
                    <button class="emergency-btn bg-red-500 hover:bg-red-600 flex flex-col items-center justify-center gap-1 py-2.5 rounded-xl shadow-md shadow-red-200" @click="openConfirm('accident')">
                    ...
                    <button class="emergency-btn bg-amber-500 hover:bg-amber-600 flex flex-col items-center justify-center gap-1 py-2.5 rounded-xl shadow-md shadow-amber-200" @click="openConfirm('breakdown')">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/>
                        </svg>
                        <span class="text-[11px] font-bold text-white tracking-tight">차량고장</span>
                    </button>
                    <button class="emergency-btn bg-slate-600 hover:bg-slate-700 flex flex-col items-center justify-center gap-1 py-2.5 rounded-xl shadow-md shadow-slate-200" @click="openConfirm('other')">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
                        </svg>
                        <span class="text-[11px] font-bold text-white tracking-tight">기타문의</span>
                    </button>
                    <button @click="emergencyCall" class="emergency-btn bg-red-600 hover:bg-red-700 flex flex-col items-center justify-center gap-1 py-2.5 rounded-xl shadow-md shadow-red-300 ring-2 ring-red-100 animate-pulse">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
