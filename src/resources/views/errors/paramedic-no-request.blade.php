{{--
    구급대의 신고 작성 차단 (2026-08-12 현장 결정, 피드백 #4).

    「구조대 계정은 '구조요청' 삭제 — 단순 지령만 받을 수 있게」. 메뉴에서 숨기는 게
    아니라 기능 자체를 막는 결정이었다.

    판정 기준은 «지금 행사에서 구급대인가»다(시스템 롤이 아니다 — 그 롤은 2026-08-12 에
    없앴다). 행사가 끝나면 이 화면도 안 뜨고 평범하게 신고할 수 있다.
