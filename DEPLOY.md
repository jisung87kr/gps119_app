...
## 0. 지금 떠 있는 것 (최초 설치 2026-08-10 · **최종 배포 2026-09-07 `ea993dc`**)
...
- [ ] **실기기 푸시 종단 검증(운영 서버 대상)** — 지금까지 앱 푸시는 개발 서버로만 검증됐다.
      ...
      ✅ **같은 날 22:10 KST 해소** — Apple Developer 에서 «Sandbox & Production» 키 `5YP6MW3RP8` 을 만들어 Firebase Cloud Messaging 에 교체, 진단 발송 FCM 200. 실기기 수신 확인은 현장(트래커 §6-4)
